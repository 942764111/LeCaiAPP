 ...
 * 邮箱注册
 */
var EmailRegisteredLayer=LoginBaseLayer.extend({
    _mobileNumBox:null,
    _passwordBox:null,
    ...
    ctor:function () {
        ...
        var mobileLoginStr = new cc.LabelTTF("用户注册","微软雅黑", 30);
        ...
        line4.setNormalizedPosition(0.5, 0.7);
        this.addChild(line4);
        ...
        line5.setNormalizedPosition(0.5, 0.62);
        this.addChild(line5);
    ...
    editBoxEditingDidEnd: function (editBox) {
        ...
        switch(editBox.getName())
        {
            case"mobileNumBox":
                ...
                {
                    var alertStr = new th.AlertLayer(_self,res.png_img_tishikuang,"请输入正确的用户名");
